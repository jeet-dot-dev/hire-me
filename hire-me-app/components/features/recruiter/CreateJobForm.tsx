"use client";
import AdditionalInformationSection from "@/components/layout/job-form-sections/AdditionalInformationSection";
import BasicInformationSection from "@/components/layout/job-form-sections/BasicInformationSection";
import { InterviewDetailsSection } from "@/components/layout/job-form-sections/InterviewDetailsSection";
import JobDescriptionSection from "@/components/layout/job-form-sections/JobDescriptionSection";
import TagsSection from "@/components/layout/job-form-sections/TagsSection";
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
   ...
   await axios.post(endpoint, formData);
    ...
    const backendMessage = error instanceof Error ? error.message : "Something went wrong.";
