...
import { Search, FileUser, Bookmark, PanelRight, LogOut } from "lucide-react";
import {
  IconArrowLeft,
  IconBrandTabler,  
  IconUserBolt,
          ...
          <SidebarBody className="justify-between gap-10 bg-neutral-900 border-neutral-700">
            <div className="flex flex-1 flex-col overflow-x-hidden overflow-y-auto">
              ...
              <div className="flex items-center justify-between mb-4">
                <a href="#" className="text-white font-bold mt-5 text-2xl">Hire-me</a>
              ...
              <div className="flex flex-col gap-2">
                {links.map((link, idx) => (
                  <SidebarLink key={idx} link={link} className="text-neutral-400 hover:text-white" />
                ))}
              </div>
            </div>
